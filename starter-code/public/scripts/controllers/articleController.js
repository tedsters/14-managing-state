...
(function(module) {
  ...
  // It is called by the author route in routes.js. It's input data from the author drop down menu. It then invokes the find where method and appends the author name to the URL.
